...
exports.configColor = exports.removeOpacityHelpers = exports.colorOpacity = exports.color = void 0;
...
exports.removeOpacityHelpers = removeOpacityHelpers;
const STYLE_PROPS = {
...
function hexToRgba(hex) {
    ...
    if (!result) {
        (0, helpers_1.warn)(`invalid config hex color value: ${orig}`);
        return `rgba(0, 0, 0, 1)`;
    }
...
function configColor(colorName, config) {
    ...
    else if ((0, types_1.isObject)(color) && (0, types_1.isString)(color.DEFAULT)) {
    ...
    while (colorNameStart !== colorName) {
        ...
        if ((0, types_1.isObject)(subConfig)) {
...
exports.configColor = configColor;
